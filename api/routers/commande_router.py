...
# create a requirement condition of being an OP-colis or Admin, can be used on routes
OpColisOrAdminOnly = require_roles("OP-colis", "Admin")
...
@router.post("/", status_code=201, response_model=CommandeInDB,
    dependencies=[Depends(OpColisOrAdminOnly)])
